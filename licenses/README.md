...
|---|---|---|---|---|---|
| uniref90 (seq reservoir) | — (`UNIREF_FASTA`) | UniProt | CC BY 4.0 | [CC-BY-4.0.txt](CC-BY-4.0.txt) | ✅ |
| pdb (struct reservoir) | `download_pdb.sh` | RCSB / wwPDB | CC0 1.0 | [CC0-1.0.txt](CC0-1.0.txt) | ✅ |
| ddg (thermompnn) | `download_ddg.sh` | github Kuhlman-Lab/ThermoMPNN | MIT | [MIT-ThermoMPNN.txt](MIT-ThermoMPNN.txt) | ✅ |
| dms (proteingym) | `download_proteingym.sh` | github OATML-Markslab/ProteinGym | MIT (data: cite source assays) | [MIT-ProteinGym.txt](MIT-ProteinGym.txt) | ✅ |
| go (bioreason-pro) | `download_bioreason_go.sh` | hf wanglab/bioreason-pro-test-data | Apache 2.0 | [Apache-2.0.txt](Apache-2.0.txt) | ✅ |
| allobench | `download_allobench.sh` | github djmaity/allobench | MIT (data ex-ASD, CC BY) | [MIT-allobench.txt](MIT-allobench.txt) | ✅ |
| ppi | `download_ppi.sh` | figshare 21591618 (Bernett) | CC BY 4.0 | [CC-BY-4.0.txt](CC-BY-4.0.txt) | ✅ |
| passerrank | `download_passerrank.sh` | ASD table + UniProt seqs | CC BY 4.0 (see note) | [CC-BY-4.0.txt](CC-BY-4.0.txt) | ✅ |
| bindingdb | `download_bindb.sh` | bindingdb.org (Articles subset) | CC BY 4.0 | [CC-BY-4.0.txt](CC-BY-4.0.txt) | ✅ |
| **pdbbind** (lp-pdbbind) | `download_pdbbind.sh` | github THGLab/LP-PDBBind | **UC Regents — research / non-profit only** | [LP-PDBBind-LICENSE.txt](LP-PDBBind-LICENSE.txt) | ❌ |
| **atlas** | `download_atlas.sh` | dsimb.inserm.fr | **CC BY-NC 4.0** | [CC-BY-NC-4.0.txt](CC-BY-NC-4.0.txt) | ❌ |
